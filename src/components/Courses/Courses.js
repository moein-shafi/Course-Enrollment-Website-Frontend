...
class TableRow extends React.Component {
    ...
    deleteOffering(code)  {
        const response = axios.delete('http://87.247.185.122:31123/course', {
            headers: {
...
class SelectedCourses extends React.Component {
    ...
    submitSelected(){
        const response = axios.post('http://87.247.185.122:31123/course', {action: "submit"},{
            headers: {
                "Authorization": `Bearer ${localStorage.getItem("token")}`,
                'Content-Type': 'application/json'
            }})
    ...
    refreshSelected(){
        const response = axios.post('http://87.247.185.122:31123/course', {action: "reset"},{
            headers: {
                "Authorization": `Bearer ${localStorage.getItem("token")}`,
                'Content-Type': 'application/json'
            }})
...
class OfferingRow extends React.Component {
    ...
    addCourse(code, classCode, hasCapacity){
        ...
        const response = axios.put('http://87.247.185.122:31123/course', {courseCode: code, classCode: classCode, isWaiting:!hasCapacity},{
...
class Courses extends React.Component {
    ...
    getCoursesDataReq = () => {
        const getData = () => {
            const token = localStorage.getItem("token");
            axios.get('http://87.247.185.122:31123/course', {headers: {
